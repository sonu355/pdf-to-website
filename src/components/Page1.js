  ...
  return (
    <div className="container" style={{ marginTop: "150px", marginLeft: "200px", marginBottom: '150px', marginRight:'200px' }}>
        ...
        <Row className="d-flex container" style={{ marginTop:'50px'}}>
            ...
            <Col sm={12} md={6} style={{ marginLeft:"-14vh"}}>
                <Row >
                    <Col sm={4} md={4}><Button variant="none" style={{border:'0.5px solid grey', borderRadius:'30px'}}>Cross-Marketing</Button></Col>
                    <Col sm={4} md={4}><Button variant="none" style={{border:'0.5px solid grey', borderRadius:'30px',marginLeft:'-6vh'}}>Rewards & incentives</Button></Col>
                </Row>
                <Row className="mt-2 mb-2">
                    <Col sm={6} md={6}><Button variant="none" style={{border:'0.5px solid grey', borderRadius:'30px'}}>CRM</Button></Col>
                    <Col sm={6} md={6}><Button variant="none" style={{border:'0.5px solid grey', borderRadius:'30px',  marginLeft:"-30vh"}}>Buyer Journey Optimization</Button></Col>
                </Row>
                <Row>
                    <Col sm={4} md={4}><Button variant="none" style={{border:'0.5px solid grey', borderRadius:'30px'}}>Data Collection</Button></Col>
                    <Col sm={4} md={4}><Button variant="none" style={{border:'0.5px solid grey', borderRadius:'30px', marginLeft:"-8vh"}}>Social Tools</Button></Col>
                </Row>
            </Col>
        </Row>    
    </div>
